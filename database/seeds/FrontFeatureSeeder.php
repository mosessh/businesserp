...
class FrontFeatureSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $client->answer = '<span style="color: rgb(68, 68, 68); font-family: Lato, sans-serif; font-size: 16px;">Yes, definitely. We would be happy to demonstrate you aiimserp through a web conference at your convenience. Please submit a query on our contact us page or drop a mail to our mail id aiimserp@froiden.com.</span>';
        $client->save();
