...
class CreateSeoDetailsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $seoDetail->seo_author = $globalSetting ? $globalSetting->company_name : 'aiimserp';
        ...
        $seoDetail->seo_description = 'aiimserp saas is easy to use CRM software that is designed for B2B. It include  everything you need to run your businesses. like manage customers, projects, invoices, estimates, timelogs, contract and much more.';
        $seoDetail->save();
