...
+function($, window){
  ...
  // Config application
  //
  aiimserp.config = function(options) {
    //$.extend(true, aiimserp.defaults, options);

    // Rteurn config value
    if ( typeof options === 'string' ) {
      return aiimserp.defaults[options];
    }
    ...
    //
    if ( !aiimserp.defaults.smoothScroll ) {
    ...
    if ( $('[data-provide~="map"]').length && window["google.maps.Map"] === undefined ) {
      $.getScript("https://maps.googleapis.com/maps/api/js?key="+ aiimserp.defaults.googleApiKey +"&callback=aiimserp.map");
    }


    // Google Analytics
    //
    if ( aiimserp.defaults.googleAnalyticsId ) {
      (function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){
      (i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),
      m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)
      })(window,document,'script','https://www.google-analytics.com/analytics.js','ga');

      ga('create', aiimserp.defaults.googleAnalyticsId, 'auto');
      ga('send', 'pageview');
    }
    ...
    if ( $('[data-provide~="recaptcha"]').length && window["grecaptcha"] === undefined ) {
      ...
      if ( aiimserp.defaults.reCaptchaLanguage != '' ) {
        url += '&hl=' + aiimserp.defaults.reCaptchaLanguage;
      }
      $.getScript(url);
    }
  ...
  aiimserp.parallax = function() {
    ...
    $('[data-parallax]').each(function() {
      ...
      options = $.extend( options, aiimserp.getDataOptions(parallax));
  ...
  aiimserp.map = function() {
    ...
    $('[data-provide~="map"]').each(function() {
      ...
      setting = $.extend(setting, aiimserp.getDataOptions($(this)));
  ...
  // Google reCAPTCHA
  //----------------------------------------------------/
  aiimserp.recaptcha = function() {
    $('[data-provide~="recaptcha"]').each(function() {

      var options = {
        sitekey: aiimserp.defaults.reCaptchaSiteKey
      }

      options = $.extend(options, aiimserp.getDataOptions($(this)));
  ...
  aiimserp.carousel = function() {
    ...
    $('.swiper-container').each(function(){
      ...
      options = $.extend( options, aiimserp.getDataOptions(swiper));
  ...
  aiimserp.typed = function() {
    ...
    $('[data-type]').each(function(){
      ...
      options = $.extend( options, aiimserp.getDataOptions(el) );
  ...
  // Constellation
  //----------------------------------------------------/
  aiimserp.constellation = function() {
  ...
  //
  aiimserp.getDataOptions = function(el, castList) {
    var options = {};

    $.each( $(el).data(), function(key, value){

      key = aiimserp.dataToOption(key);
  ...
  //
  aiimserp.optionToData = function(name) {
  ...
  //
  aiimserp.dataToOption = function(name) {
    return name.replace(/-([a-z])/g, function(x){return x[1].toUpperCase();});
  }



  window.aiimserp = aiimserp;
}(jQuery, window);
